...
// Variables
const rootDomain = "heri.web.id"; // Ganti dengan domain utama kalian
const serviceName = "vpn"; // Ganti dengan nama workers kalian
const apiKey = "3390089157d39962df0efe3dfbac8cc6cf216"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "mheri6123@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "ca2ed3e3246b73bcac6183eec2e339e0"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "b683884bbf136d18550763fd30398c67"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
